...
If a partner has no commits in the repositories, they will receive a 0
    My partner's Visual Studio Code with OpenFrameworks was not working, we executed the whole project through my laptop, 
    he was connected with me the entire time we worked on it via Google Meets. 
